            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-offset-3 col-lg-6 col-sm-6 well">
                        <legend>Registro de departamentos</legend>

                        <?php
                        $attributes = array("class" => "form-horizontal", "id" => "departamentoform", "name" => "departamentoform");
                        echo form_open("departamento/add", $attributes);?>
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="row colbox">
                                    ...
                                    <div class="col-lg-8 col-sm-8">
                                        <input id="nombre" name="nombre" placeholder="Nombre del departamento" type="text" class="form-control"  value="<?php echo set_value('nombre'); ?>" />

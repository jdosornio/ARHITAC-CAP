            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-offset-3 col-lg-6 col-sm-6 well">
                        <legend>Modificar puesto</legend>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="row colbox">
                                    ...
                                    <div class="col-lg-8 col-sm-8">
                                        <input id="id" name="id" type="text" disabled="disabled" class="form-control" value="<?php echo $puesto->id; ?>" />
                            ...
                            <div class="form-group">
                                <div class="row colbox">
                                    ...
                                    <div class="col-lg-8 col-sm-8">
                                        <input id="nombre" name="nombre" placeholder="Nombre del puesto" type="text" class="form-control"  value="<?php echo $puesto->nombre; ?>" />

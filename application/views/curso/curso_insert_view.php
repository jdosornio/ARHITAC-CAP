            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-offset-3 col-lg-6 col-sm-6 well">
                        ...
                        echo form_open("curso/add", $attributes);?>
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="row colbox">
                                    ...
                                    <div class="col-lg-8 col-sm-8">
                                        <input id="nombre" name="nombre" placeholder="Nombre del curso" type="text" class="form-control"  value="<?php echo set_value('nombre'); ?>" />
                            ...
                            <div class="form-group">
                                <div class="row colbox">
                                    ...
                                    <div class="col-lg-8 col-sm-8">
                                        <input id="descripcion" name="descripcion" placeholder="Descripción del Curso" type="text" class="form-control"  value="<?php echo set_value('descripcion'); ?>" />
